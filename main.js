...
function renderHome() {
  ...
  app.innerHTML = `<div class="intro intro-with-feedback"><div><h1>Commerce XI Maths App – Free Maharashtra Board Practice Tests</h1><p class="home-description">Free Standard XI Commerce Mathematics and Statistics practice tests, detailed answers and study guides based on the Maharashtra State Board English-medium textbooks.</p><strong class="practice-heading">Choose a Practice Test</strong><div class="muted">Exam → Unit → Paper → Start Paper</div></div><div class="developer-contact"><a class="primary download-link" href="mailto:arvindhatkar1974@gmail.com?subject=Commerce%20XI%20Maths%20App%20%E2%80%93%20Feedback&amp;body=Paper%20name%3A%20%0D%0AQuestion%20number%3A%20%0D%0AFeedback%20or%20problem%3A%20">Feedback / Ask Developer</a><p class="small-note"><span>Report a question, answer mismatch, technical problem or suggestion.</span><span>Contact developer: <a href="mailto:arvindhatkar1974@gmail.com">arvindhatkar1974@gmail.com</a></span></p></div></div>
    ...
    <div class="grid selection-grid">
      ...
      <section class="card study-guide-card"><h2>${selection.unit <= 9 ? `Unit-${selection.unit} Reference Guide` : 'Reference Guide'}</h2>${selection.part === 1 && selection.unit === 1 ? `<a class="primary download-link guide-link" href="${UNIT1_GUIDE_PDF}" download="Part1Unit1-Reference-Guide.pdf">📘 Sets and Relations (Reference Guide)</a><p class="small-note">Review the important notation, laws, theorems and formulae before starting a test.</p>` : selection.part === 1 && selection.unit === 2 ? `<a class="primary download-link guide-link" href="${UNIT2_GUIDE_PDF}" download="Part1Unit2-Reference-Guide.pdf">📘 Functions (Reference Guide)</a><p class="small-note">Review function notation, types, domains, ranges, operations, composition, inverses and standard graphs before starting a test.</p>` : selection.part === 1 && selection.unit === 3 ? `<a class="primary download-link guide-link" href="${UNIT3_GUIDE_PDF}" download="Part1Unit3-Reference-Guide.pdf">📘 Complex Numbers (Reference Guide)</a><p class="small-note">Review imaginary-unit powers, complex-number operations, conjugates, quadratic roots and cube roots of unity before starting a test.</p>` : selection.part === 2 && selection.unit === 1 ? `<a class="primary download-link guide-link" href="${PART2_UNIT1_GUIDE_PDF}" download="Part2Unit1-Reference-Guide.pdf">📘 Partition Values (Reference Guide)</a><p class="small-note">Review quartiles, deciles, percentiles, grouped-data formulae and ogives before starting a test.</p>` : selection.part === 2 && selection.unit === 2 ? `<a class="primary download-link guide-link" href="${PART2_UNIT2_GUIDE_PDF}" download="Part2Unit2-Reference-Guide.pdf">📘 Measures of Dispersion (Reference Guide)</a><p class="small-note">Review range, quartile deviation, variance, standard deviation, combined groups and coefficient of variation before starting a test.</p>` : '<p class="small-note">The reference guide for this selection is being prepared.</p>'}</section>
    </div>
...
function renderResult(result) {
  ...
  const studyGuideLink = resultPart === 1 && resultUnit === 1 ? `<a class="secondary download-link" href="${UNIT1_GUIDE_PDF}" download="Part1Unit1-Reference-Guide.pdf">Download Sets and Relations (Reference Guide)</a>` : resultPart === 1 && resultUnit === 2 ? `<a class="secondary download-link" href="${UNIT2_GUIDE_PDF}" download="Part1Unit2-Reference-Guide.pdf">Download Functions (Reference Guide)</a>` : resultPart === 1 && resultUnit === 3 ? `<a class="secondary download-link" href="${UNIT3_GUIDE_PDF}" download="Part1Unit3-Reference-Guide.pdf">Download Complex Numbers (Reference Guide)</a>` : resultPart === 2 && resultUnit === 1 ? `<a class="secondary download-link" href="${PART2_UNIT1_GUIDE_PDF}" download="Part2Unit1-Reference-Guide.pdf">Download Partition Values (Reference Guide)</a>` : resultPart === 2 && resultUnit === 2 ? `<a class="secondary download-link" href="${PART2_UNIT2_GUIDE_PDF}" download="Part2Unit2-Reference-Guide.pdf">Download Measures of Dispersion (Reference Guide)</a>` : '';
