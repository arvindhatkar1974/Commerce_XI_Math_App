...
function renderResult(result) {
  ...
  const studyGuideLink = resultPart === 1 && resultUnit === 1 ? `<a class="secondary download-link" href="${UNIT1_GUIDE_PDF}" download>Download Sets and Relations (Reference Guide)</a>` : resultPart === 1 && resultUnit === 2 ? `<a class="secondary download-link" href="${UNIT2_GUIDE_PDF}" download>Download Functions (Reference Guide)</a>` : resultPart === 1 && resultUnit === 3 ? `<a class="secondary download-link" href="${UNIT3_GUIDE_PDF}" download>Download Complex Numbers (Reference Guide)</a>` : resultPart === 2 && resultUnit === 1 ? `<a class="secondary download-link" href="${PART2_UNIT1_GUIDE_PDF}" download>Download Partition Values (Reference Guide)</a>` : resultPart === 2 && resultUnit === 2 ? `<a class="secondary download-link" href="${PART2_UNIT2_GUIDE_PDF}" download>Download Measures of Dispersion (Reference Guide)</a>` : '';
