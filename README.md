...
Unit 1 and Unit 2 each provide a downloadable study guide on the home page and result page. The Unit 2 guide summarizes function notation, domain and range, function types, standard functions, operations, composition, inverse functions, graph reading, and key domain checks.
